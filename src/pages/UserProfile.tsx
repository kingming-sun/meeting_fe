  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-6">
      ...
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">个人中心</h1>
        <p className="mt-1 md:mt-2 text-sm md:text-base text-gray-600">管理您的个人信息和账户设置</p>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
            <div className="text-center">
              ...
              <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-1 truncate">{user.username}</h3>
              <p className="text-xs md:text-sm text-gray-500 mb-3 md:mb-4">{getUserTagText(user.tag)}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mt-4 md:mt-6">
            <h4 className="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4">使用统计</h4>
